package com.meoguri.linkocean.support.internal.persistence.aop;
...
public class FindByIdNullToLinkoceanRuntimeExceptionAop {
	...
	@Around("@within(com.meoguri.linkocean.support.internal.persistence.aop.RequireSingleResult)"
		+ " && args(long)")
